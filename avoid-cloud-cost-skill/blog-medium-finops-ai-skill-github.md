...
*A ~2-minute read on Finops-AI-Skills — with a look inside every prompt that powers it.*

> 📦 **GitHub:** [github.com/sdubeyslb/finops-ai-skills](https://github.com/sdubeyslb/finops-ai-skills)
...
**Get it on GitHub:** [github.com/sdubeyslb/finops-ai-skills](https://github.com/sdubeyslb/finops-ai-skills)
Clone it, add a `skill-config/avoid-cloud-cost-config.yaml` to your repo, invoke the skill with the Claude Code CLI, and read the report. MIT licensed · Node.js ≥ 16.
